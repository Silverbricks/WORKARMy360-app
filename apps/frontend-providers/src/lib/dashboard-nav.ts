...
export const DASHBOARD_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Staff Planner', href: '/dashboard/rosters', icon: 'calendar' },
      { label: 'Roster Grid', href: '/dashboard/rosters?tab=grid', icon: 'sliders' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Forms & Inspections', href: '/dashboard/forms', icon: 'clipboard' },
